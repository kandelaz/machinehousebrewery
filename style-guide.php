...
<div class="centered">		
	...
	<section id="main-content">
		...
		<p id='start'><!-- Sample content to plug in to template --></p>

		<p>This HTML contains a wide variety of markup elements: drop it into a page on your site to make sure you have set CSS styles for each possible element that may be added to your content in the future.</p>
		<hr />
		<h1>Heading 1</h1>
		<h2>Heading 2</h2>
		<h3>Heading 3</h3>
		...
		<h5>Heading 5</h5>
		<h6>Heading 6</h6>
		<p><small><a href="#start">[top]</a></small></p>
		...
		<p><small><a href="#start">[top]</a></small><br />
		
		<!-- End of Sample Content --></p>


 </div> <!-- middle-posts ends -->

	<aside>
      <p>"This is our<br>STYLE GUIDE PAGE."</p>
    </aside><!-- aside ends -->  
